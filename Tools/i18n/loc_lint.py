...
brace and is not a placeholder. The Inno setup (plan P3b) uses %1 and %n instead; when inno.tsv
arrives, this script gets a second placeholder grammar behind a flag, NOT a relaxed one.
"""
